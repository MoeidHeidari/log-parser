...
import {
  LOG_PARSER_TEST_CASE_1,
  LOG_PARSER_TEST_CASE_2,
  LOG_PARSER_TEST_CASE_3,
  LOG_PARSER_TEST_CASE_4,
  LOG_PARSER_TEST_CASE_5,
  LOG_PARSER_TEST_CASE_6,
...
describe('tests the behavior of file helper class', () => {
  ...
  it(LOG_PARSER_TEST_CASE_1.expectation.should, async () => {
    ...
    expect(result.logLevel).toEqual(
      LOG_PARSER_TEST_CASE_1.expectation.value.logLevel,
    );
    expect(result.transactionId).toEqual(
      LOG_PARSER_TEST_CASE_1.expectation.value.transactionId,
    );
  ...
  it(LOG_PARSER_TEST_CASE_6.expectation.should, async () => {
    ...
    expect(result.logLevel).toEqual(
      LOG_PARSER_TEST_CASE_6.expectation.value.logLevel,
    );
  });
  //..................................................................................................................
  it(LOG_PARSER_TEST_CASE_7.expectation.should, async () => {
    ...
    expect(result.logLevel).toEqual(
      LOG_PARSER_TEST_CASE_7.expectation.value.logLevel,
    );
    expect(result.transactionId).toEqual(
  ...
  it(LOG_PARSER_TEST_CASE_8.expectation.should, async () => {
    ...
    expect(result.logLevel).toEqual(
      LOG_PARSER_TEST_CASE_8.expectation.value.logLevel,
    );
    expect(result.transactionId).toEqual(
      LOG_PARSER_TEST_CASE_8.expectation.value.transactionId,
    );
